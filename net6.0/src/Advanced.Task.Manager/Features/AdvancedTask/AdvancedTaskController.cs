...
namespace Advanced.Task.Manager.Features.AdvancedTask
{
    ...
    public class AdvancedTaskController : Controller
    {
        ...
        private async System.Threading.Tasks.Task ChangeApprovalModel(AdvancedTaskIndexViewData viewModel)
        {
        ...
        private async System.Threading.Tasks.Task ApproveContent(string values, string approvalComment, bool publishContent)
        {
        ...
        private async System.Threading.Tasks.Task AbortTasks(List<int> ids)
        {
